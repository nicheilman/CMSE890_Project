...
import pyvista
import BC
from fluids import epsilon, sigma, Inflow
...
k = Constant(mesh, PETSc.ScalarType(dt)) # Relaxation time
mu = Constant(mesh, PETSc.ScalarType(0.046)) # Dynamic Viscosity
